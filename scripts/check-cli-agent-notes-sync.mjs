...
// AGENTS.md Part 1 is canonical; docs/CODEX-WORKING-NOTES.md is its mirror.
...
const tmp2 = join(diffDir, 'mirror.txt');
writeFileSync(tmp1, agentsBody);
writeFileSync(tmp2, docBody);

console.error('FAIL: docs/CODEX-WORKING-NOTES.md has drifted from AGENTS.md Part 1 (canonical).');
console.error('');
try {
...
console.error('');
console.error('To fix: replace the docs/CODEX-WORKING-NOTES.md body with AGENTS.md Part 1 body (skip the H1 and Part 2 separator).');
process.exit(1);
