...
**Verification recipe:** tests/scripts/check-strategic-claims.test.sh
...
- Six-principle framing tracking the wedge: `docs/01_VISION_DOCUMENT.md` "Six Design Principles" (moved here from CLAUDE.md's Strategic Vision section, Phase 2 slimming, 2026-08-07)
