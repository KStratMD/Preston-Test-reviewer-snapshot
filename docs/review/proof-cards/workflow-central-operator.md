...
**Verification recipe:** tests/unit/services/workflowCentral/WorkflowCentralRepository.test.ts
...
- **NetSuite per-tenant governance API quotas** could be exhausted by render bursts. Mitigated by cache + the existing Governance Pacer (`docs/01_VISION_DOCUMENT.md` "Production-Ready Features"). Open Question Q5.
