...
- **Module/feature relevance (per `docs/01_VISION_DOCUMENT.md`):** NL Action Gate (6 actions + LLM intent) — could power AI-assisted customer self-service. Context Sidecar — could embed AI affordances in the existing NetSuite-resident UI. Both are speculative until CustomerCentral-specific feature work happens.
