...
| `!src/routes/aiConfig.ts` | No unit tests (audited 2026-04-30); 69.35% coverage would pull broad-CI thresholds down |
| `!src/routes/aiDemo.ts` | No unit tests (audited 2026-04-30); 69.35% coverage would pull broad-CI thresholds down |
