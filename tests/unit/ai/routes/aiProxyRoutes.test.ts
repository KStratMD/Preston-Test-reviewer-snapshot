...
describe('AI Proxy Routes', () => {
  ...
  beforeAll(async () => {
    ...
    // The production mount (mountAiProxyRoutes) guarantees a verified user at
    // every handler that reads identity; this bare mount must model that, or
    // the handlers' fail-closed F6 identity guard refuses before validation.
