...
describe('AuthenticationMiddleware', () => {
  ...
  describe('authenticate()', () => {
    ...
    describe('OAuth2 authentication', () => {
      ...
      it('should reject OAuth claims without a usable subject', async () => {
        mockReq.headers = { authorization: 'Bearer subjectless-token' };
        mockOAuthService.validateAccessToken.mockResolvedValue({
          scope: 'read',
          tenant_id: 'tenant-1',
        } as OIDCClaims);
      ...
      it('should reject OAuth claims with a blank subject', async () => {
        mockReq.headers = { authorization: 'Bearer blank-sub-token' };
        mockOAuthService.validateAccessToken.mockResolvedValue({
          sub: '   ',
          scope: 'read',
          tenant_id: 'tenant-1',
