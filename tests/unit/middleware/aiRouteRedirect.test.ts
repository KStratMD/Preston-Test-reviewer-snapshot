...
describe('getAIProxyRedirectUrl', () => {
  it.each([
    ...
    ['/api/ai/field-mapping/feedback', '/api/ai/proxy/mapping/feedback'],
    ['/api/ai/field-mapping/feedback?datasetId=default', '/api/ai/proxy/mapping/feedback?datasetId=default'],
