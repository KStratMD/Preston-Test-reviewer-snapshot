...
describe('SecureConfigurationService', () => {
  ...
  describe('getSecureIntegration', () => {
    it('should return integration with resolved credentials', async () => {
      const result = await service.getSecureIntegration('test-tenant', 'integration-1');
    ...
    it('should throw error for non-existent integration', async () => {
      ...
      await expect(service.getSecureIntegration('test-tenant', 'not-found'))
    ...
    it('should handle credential resolution errors', async () => {
      ...
      await expect(service.getSecureIntegration('test-tenant', 'integration-1'))
  ...
  describe('updateIntegrationCredentials', () => {
    it('should update source credentials', async () => {
      ...
      await service.updateIntegrationCredentials('test-tenant', 'integration-1', 'source', newCredentials);
    ...
    it('should update target credentials', async () => {
      ...
      await service.updateIntegrationCredentials('test-tenant', 'integration-1', 'target', newCredentials);
    ...
    it('should throw error for non-existent integration', async () => {
      ...
      await expect(service.updateIntegrationCredentials('test-tenant', 'not-found', 'source', {}))
        .rejects.toThrow('Integration not-found not found');
    });
    ...
    it('should throw error when not using secret manager', async () => {
      ...
      await expect(service.updateIntegrationCredentials('test-tenant', 'integration-2', 'source', {}))
  ...
  describe('error handling', () => {
    ...
    it('should handle invalid credential format', async () => {
      ...
      await expect(service.updateIntegrationCredentials('test-tenant', 'int-1', 'source', { invalid: true }))
