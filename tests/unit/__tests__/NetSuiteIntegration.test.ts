...
import { createMockOutboundGovernanceService, createMockOwnershipResolver, createMockAuditService, createMockApprovalQueueService, createMockConnectorManager, createMockSerializedAssetSyncService } from '../../governanceTestUtils';
...
describe('NetSuite Integration with New Connectors', () => {
  ...
  beforeEach(() => {
    ...
    integrationService = new IntegrationService(
      ...
      createMockConnectorManager() as any, // 10th: ConnectorManager (Task 8)
  ...
  describe('Multi-System Validation', () => {
    it('should properly validate all supported system combinations', async () => {
      ...
      for (const pair of supportedCombinations) {
