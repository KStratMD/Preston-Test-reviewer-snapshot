...
describe('OracleConnector - Demo Mode', () => {
  ...
  describe('Demo Mode Initialization', () => {
    ...
    it('should enable demo mode in development environment', async () => {
      ...
      const devConnector = new OracleConnector('oracle-dev', mockLogger, mockAuthService, createMockOutboundGovernanceService());
    ...
    it('should enable demo mode when DEMO_MODE=1', async () => {
      ...
      const demoConnector = new OracleConnector('oracle-demo', mockLogger, mockAuthService, createMockOutboundGovernanceService());
