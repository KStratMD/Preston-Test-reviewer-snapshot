...
- Connector partition: <!-- METRIC:connectors.production -->0<!-- /METRIC --> production, <!-- METRIC:connectors.production_ready -->5<!-- /METRIC --> production-ready, <!-- METRIC:connectors.beta -->1<!-- /METRIC --> beta, <!-- METRIC:connectors.demo_only -->11<!-- /METRIC --> demo-mode, <!-- METRIC:connectors.stub -->1<!-- /METRIC --> stub (verify with `npm run audit-status-claims`)
