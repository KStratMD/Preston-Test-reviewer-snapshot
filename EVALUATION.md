...
- Production TypeScript coverage scope LOC: <!-- METRIC:loc.production_ts -->209097<!-- /METRIC -->.
- Total TypeScript LOC: <!-- METRIC:loc.total_ts -->400295<!-- /METRIC -->.
- Total Markdown LOC: <!-- METRIC:loc.total_md -->257039<!-- /METRIC -->.
