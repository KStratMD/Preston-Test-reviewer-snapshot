...
import { migration as m058 } from './058-create-deferred-serialized-units-table';
import { migration as m059 } from './059-create-serialized-asset-sweep-cursors-table';
import { migration as m060 } from './060-redact-presanitizer-reasoning-trace-content';
import { migration as m061 } from './061-delete-system-tenant-demo-fixtures';
import { migration as m062 } from './062-add-governance-approval-request-fingerprint';
import { migration as m063 } from './063-create-serialized-asset-retry-operations-table';
import { migration as m064 } from './064-widen-transfer-float-columns';
import { migration as m065 } from './065-create-embedded-role-grants';
...
export type MigrationName =
  ...
  | 'create_deferred_serialized_units_table'
  | 'create_serialized_asset_sweep_cursors_table'
  | 'redact_presanitizer_reasoning_trace_content'
  | 'delete_system_tenant_demo_fixtures'
  | 'add_governance_approval_request_fingerprint'
  | 'create_serialized_asset_retry_operations_table'
  | 'widen_transfer_float_columns'
  | 'create_embedded_role_grants';
