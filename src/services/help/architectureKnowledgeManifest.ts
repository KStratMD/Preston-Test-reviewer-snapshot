...
export const architectureKnowledgeNodes: readonly ArchitectureKnowledgeNode[] = [
  {
    ...
    wikiPaths: ['/wiki/pages/architecture/user-operator-surfaces.html'],
  ...
  },
  {
    ...
    wikiPaths: ['/wiki/pages/architecture/http-api-edge.html'],
    sourceFiles: [
  ...
  },
  {
    ...
    wikiPaths: ['/wiki/pages/architecture/core-application-services.html'],
    sourceFiles: [
  ...
  },
  {
    ...
    wikiPaths: ['/wiki/pages/architecture/ai-intelligence.html'],
    sourceFiles: [
  ...
  },
  {
    ...
    wikiPaths: ['/wiki/pages/architecture/governance-safety.html'],
    sourceFiles: [
  ...
  },
  {
    ...
    docPaths: ['docs/architecture/PRODUCTION-VS-DEMO-GUIDE.md'],
    wikiPaths: ['/wiki/pages/architecture/connector-integration-layer.html'],
    sourceFiles: [
  ...
  },
  {
    ...
    wikiPaths: ['/wiki/pages/architecture/data-evidence-publishing.html'],
    sourceFiles: [],
    testFiles: [
