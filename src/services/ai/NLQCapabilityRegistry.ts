...
import type { FIXTURE_DATA_SOURCE } from '../../utils/dataProvenance';
...
export interface NLQExecutionResult {
    ...
    metadata: {
        // Fixture-only provenance marker, not a free-form label: this path has
        // no live upstream call, so the literal type makes "fixture" the only
        // value a caller can compile.
        dataSource: typeof FIXTURE_DATA_SOURCE;
