...
export class PaymentCentralService {
  ...
  async createInvoice(
    ...
    createdBy = 'system'
  ): Promise<Invoice> { return this.invoiceService.createInvoice(vendorId, invoiceData, createdBy); }

  /**
   * Get invoice by ID
   */
  async getInvoice(invoiceId: string): Promise<Invoice | null> { return this.invoiceService.getInvoice(invoiceId); }
  ...
  async matchInvoiceToPO(
    ...
    error?: string;
  }> { return this.invoiceService.matchInvoiceToPO(invoiceId, poId, matchedBy); }
  ...
  async autoMatchInvoice(invoiceId: string): Promise<{
    ...
    error?: string;
  }> { return this.invoiceService.autoMatchInvoice(invoiceId); }
  ...
  async approveInvoice(
    invoiceId: string,
    approvedBy: string
  ): Promise<{ success: boolean; error?: string }> { return this.invoiceService.approveInvoice(invoiceId, approvedBy); }
  ...
  async createInvoiceDispute(
    ...
    description: string,
    createdBy: string
  ): Promise<{ success: boolean; dispute?: InvoiceDispute; error?: string }> { return this.invoiceService.createInvoiceDispute(invoiceId, reason, description, createdBy); }
  ...
  async resolveDispute(
    ...
    resolvedBy: string
  ): Promise<{ success: boolean; creditMemo?: CreditMemo; error?: string }> { return this.invoiceService.resolveDispute(disputeId, resolution, resolvedBy); }
  ...
  async createCreditMemo(
    ...
    createdBy: string,
    disputeId?: string
  ): Promise<CreditMemo> { return this.invoiceService.createCreditMemo(invoiceId, amount, reason, createdBy, disputeId); }
  ...
  async getDisputes(filters: {
    ...
    limit?: number;
    offset?: number;
  } = {}): Promise<{ disputes: InvoiceDispute[]; totalCount: number }> { return this.invoiceService.getDisputes(filters); }
  ...
  async getCreditMemos(filters: {
    ...
    limit?: number;
    offset?: number;
  } = {}): Promise<{ creditMemos: CreditMemo[]; totalCount: number }> { return this.invoiceService.getCreditMemos(filters); }

  /**
   * Get invoice statistics
   */
  async getInvoiceStatistics(): Promise<InvoiceStatistics> { return this.invoiceService.getInvoiceStatistics(); }
}