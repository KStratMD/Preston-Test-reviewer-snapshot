...
// Exported (F3): embeddedTenantStatusGate reuses this as THE canonical tenant
// validator — TenantLifecycleService.requireActive requires callers to
// normalize/validate before its auto-registering lookup, and the embedded
// session store persists tenant_id verbatim at provisioning time.
