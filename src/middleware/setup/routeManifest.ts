...
export const ROUTE_MANIFEST: readonly RouteEntry[] = Object.freeze(([
  ...
  { path: '/api/metrics', classification: 'public', notes: 'Prometheus scrape; no auth' },
  ...
  { path: '/api/statistics', classification: 'system', notes: 'single-endpoint diagnostic mounted in src/index.ts; reads global configService state, not tenant-scoped' },
  ...
  { path: '/api/testing', classification: 'tenant_required' },
  ...
  { path: '/api/suitecentral/prod', classification: 'tenant_required' },
  ...
  { path: '/api/configurations', classification: 'tenant_required', notes: 'sub-route of root / mount (configurationRouter); integration configuration CRUD' },
