  ...
  fieldMappings: [
    ...
    },
    {
      ...
      transformationConfig: {
        ...
        // Codex round 13 on PR #1253: a bare table name resolved to nothing and the
        // engine reported success with the target omitted. The table travels with it.
        mappings: {
...
export const dynamicsToSalesforceConfig: IntegrationConfig = {
  ...
  sourceSystem: { type: 'Dynamics365', credentialSource: 'environment' },
  targetSystem: { type: 'Salesforce', credentialSource: 'environment' },
  sourceEntity: 'Account',
...
export const businessCentralToNetSuiteConfig: IntegrationConfig = {
  ...
  sourceSystem: { type: 'BusinessCentral', credentialSource: 'environment' },
  targetSystem: { type: 'NetSuite', credentialSource: 'environment' },
  sourceEntity: 'Item',
  targetEntity: 'Item',
  syncDirection: 'source_to_target',
  ...
  fieldMappings: [
    {
      // Business Central's item number field is literally named "No." — spelled as a
      // lodash path so the trailing period is part of the key, not an empty segment
      // (Codex round 13 on PR #1253).
      sourceField: '["No."]',
      targetField: 'itemid',
      isRequired: true,
      transformationType: 'direct',
    ...
    },
    {
      ...
      transformationConfig: {
        ...
        // Codex round 13 on PR #1253: see industry_mapping above.
        mappings: { Active: false, Blocked: true, Inactive: true },
      },
    },
  ],
  transformationRules: [
