...
class Server {
  ...
  constructor() {
    ...
    bootLog('[BOOT][Ctor] Resolving IntegrationService...');
    this.integrationService = container.get<IntegrationService>(TYPES.IntegrationService);
    bootLog('[BOOT][Ctor] IntegrationService resolved');
  ...
  private mountRouters(app: express.Application) {
    ...
    // System integration status summary used by tests
