...
- **Current shared session handoff:** [`docs/SESSION-HANDOFF-2026-08-05.md`](docs/SESSION-HANDOFF-2026-08-05.md). Read this before starting a new session; it is the repository-canonical starting point for all agents.
...
- Unit suite: ~13,305 passing, 100% on the unit profile (`jest.ci.config.cjs`).
